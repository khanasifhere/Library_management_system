...
export const fetchAllUsers=() => async (dispatch) => {
  ...
  await axios.get("https://library-management-system-six-liard.vercel.app/api/v1/user/all", {
...
export const addNewAdmin=(data)=>async (dispatch)=>{
    ...
    await axios.post("https://library-management-system-six-liard.vercel.app/api/v1/user/add/new-admin",data, {
        withCredentials: true,
        headers: {
