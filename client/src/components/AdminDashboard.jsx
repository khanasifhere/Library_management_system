  ...
  <main className="relative flex-1 p-6 pt-28 ">
   ...
   <Pie 
    ...
    className="mx-auto lg:mx-0 w-full h-auto"/>
      ...
      <div className="flex items-center p-8 w-full sm:w-[400px] xl:w-fit mr-5 xl:p-3 2xl:p-6 
      gap-5 h-fit xl:min-h-[150px] bg-white xl:flex-1 rounded-lg">
   ...
   <div className="flex flex-col gap-7 flex-1">
    ...
    rounded-lg transition hover:shadow-inner duration-300 w-full lg:max-w-[360px]">
      ...
      <span className="w-[2px] bg-black h-20 lg:h-full">
   ...
   <div className="flex flex-col lg:flex-row flex-1 mt-0">
     <div className="flex flex-col lg:flex-row flex-1 items-center justify-center">
      <div className="bg-white p-5 rounded-lg shadow-lg h-full flex flex-col justify-center items-center gap-4">
       ...
       <h2 className="text-2xl 2xl:text-2xl font-semibold text-center">{user&&user.name}</h2>
      <p className="text-gray-600 text-sm 2xl:text-base text-center">
      Welcone to your admin dashboard. Here you can manage all the settings and monitor the statistics.
      </p>
      </div>
